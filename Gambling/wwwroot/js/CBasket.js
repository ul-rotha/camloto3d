function CBasket(iX, iY, oParentContainer, oSpriteSheet, iWidth, iHeight, szText) {
    ...
    this._init = function (iX, iY, oParentContainer, oSpriteSheet, iWidth, iHeight, szText) {
        ...
        _oHighlight = createSprite(oSpriteSheet, "state_on", iWidth / 2, iHeight / 2, iWidth, iHeight - 10);
        _oHighlight.alpha = 0;
    ...
    this._setText = function (iSize) {
        ...
        _oText.y = isFirst == false ? -_oText.getBounds().height / 2 + iOffset : (-_oText.getBounds().height / 2 + iOffset) + 17.402343755;
        
        //console.log(_oText.y);
    };
